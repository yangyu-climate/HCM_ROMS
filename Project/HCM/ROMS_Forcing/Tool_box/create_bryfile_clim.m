function create_bryfile_clim(bryname,grdname,title,obc,...
                        theta_s,theta_b,hc,N,...
                        time,clobber,vtransform,cycle)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp(' ')
...
%
nc{'dye_time'} = ncdouble('dye_time') ;
nc{'dye_time'}.long_name = ncchar('time for dye climatology');
nc{'dye_time'}.long_name = 'time for dye climatology';
nc{'dye_time'}.units = ncchar('day');
nc{'dye_time'}.units = 'day';
nc{'dye_time'}.cycle_length = cycle;
%
...
%
  nc{'dye_south_01'}  = ncdouble('dye_time','s_rho','xi_rho') ;
  nc{'dye_south_02'}  = ncdouble('dye_time','s_rho','xi_rho') ;
%
end
%
if obc(2)==1
...
%
  nc{'dye_east_01'}  = ncdouble('dye_time','s_rho','eta_rho') ;
  nc{'dye_east_02'}  = ncdouble('dye_time','s_rho','eta_rho') ;
%
end
%
if obc(3)==1
...
%
  nc{'dye_north_01'} = ncdouble('dye_time','s_rho','xi_rho') ;
  nc{'dye_north_02'} = ncdouble('dye_time','s_rho','xi_rho') ;
%
end
%
if obc(4)==1
...
%
  nc{'dye_west_01'} = ncdouble('dye_time','s_rho','eta_rho') ;
  nc{'dye_west_02'} = ncdouble('dye_time','s_rho','eta_rho') ;
%
end
%
%
