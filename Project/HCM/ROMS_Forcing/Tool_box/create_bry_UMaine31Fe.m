function create_bry_UMaine31Fe(bryname,grdname,title,obc,...
...
nc('S1Fe_time')           = length(time);
nc('S2Fe_time')           = length(time);
nc('S3Fe_time')           = length(time);
...
%
nc{'S1Fe_time'} = ncdouble('S1Fe_time') ;
nc{'S1Fe_time'}.units = 'day';
nc{'S1Fe_time'}.cycle_length = cycle;%
%
nc{'S2Fe_time'} = ncdouble('S2Fe_time') ;
nc{'S2Fe_time'}.units = 'day';
nc{'S2Fe_time'}.cycle_length = cycle;%
%
nc{'S3Fe_time'} = ncdouble('S3Fe_time') ;
nc{'S3Fe_time'}.units = 'day';
nc{'S3Fe_time'}.cycle_length = cycle;%
%
...
%
  ...
  nc{'S1Fe_south'}          = ncdouble('S1Fe_time','s_rho','xi_rho') ;
  nc{'S2Fe_south'}          = ncdouble('S2Fe_time','s_rho','xi_rho') ;
  nc{'S3Fe_south'}          = ncdouble('S3Fe_time','s_rho','xi_rho') ;
  nc{'FeD_south'}           = ncdouble('bio_time','s_rho','xi_rho') ;
...
%
  ...
  nc{'S1Fe_east'}          = ncdouble('S1Fe_time','s_rho','eta_rho') ;
  nc{'S2Fe_east'}          = ncdouble('S2Fe_time','s_rho','eta_rho') ;
  nc{'S3Fe_east'}          = ncdouble('S3Fe_time','s_rho','eta_rho') ;
  nc{'FeD_east'}           = ncdouble('bio_time','s_rho','eta_rho') ;
...
%
  ...
  nc{'S1Fe_north'}          = ncdouble('S1Fe_time','s_rho','xi_rho') ;
  nc{'S2Fe_north'}          = ncdouble('S2Fe_time','s_rho','xi_rho') ;
  nc{'S3Fe_north'}          = ncdouble('S3Fe_time','s_rho','xi_rho') ;
  nc{'FeD_north'}           = ncdouble('bio_time','s_rho','xi_rho') ;
...
%
  ...
  nc{'S1Fe_west'}          = ncdouble('S1Fe_time','s_rho','eta_rho') ;
  nc{'S2Fe_west'}          = ncdouble('S2Fe_time','s_rho','eta_rho') ;
  nc{'S3Fe_west'}          = ncdouble('S3Fe_time','s_rho','eta_rho') ;
  nc{'FeD_west'}           = ncdouble('bio_time','s_rho','eta_rho') ;
