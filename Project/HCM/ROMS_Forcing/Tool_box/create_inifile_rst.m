function create_inifile_rst(inifile,gridfile,title,...
...
nccreate(inifile,'dye_01'     ,'Dimensions',{'xi_rho',Lp ,'eta_rho',Mp,'s_rho' ,N,'time' ,1},'Datatype','double')
nccreate(inifile,'dye_01_age' ,'Dimensions',{'xi_rho',Lp ,'eta_rho',Mp,'s_rho' ,N,'time' ,1},'Datatype','double')
%
%  Create attributes
%
...
ncwrite(inifile,'dye_01'    , zeros(Lp,Mp,N,length(time)))
ncwrite(inifile,'dye_01_age', zeros(Lp,Mp,N,length(time)))
