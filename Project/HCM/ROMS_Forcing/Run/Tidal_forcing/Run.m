...
% (3) Select Adcirc or topex/osu tidal constituent data 
      ...
      osu=1;
      if (adcirc)
        load ([Run_dir,'/tidal_data/adcirc_ec2001v2e_fix.mat'])
        names=names';
      end
      if (adcirc2012)
      ...
      if (osu)
        load ([Run_dir,'/tidal_data/tpx_uv.mat'])
        load ([Run_dir,'/tidal_data/tpx_h.mat'])
        names=con;
      end
