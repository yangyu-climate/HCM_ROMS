...
if (water),
  ...
  if (nargin < 3),
    v=nc_readS(fname,vname);
  else
    v=nc_readS(fname,vname,tindex);
  end,
  [Npts,Ntime]=size(v);
  ...
  if (nargin < 3),
    f=nc_readS(fname,vname);
  else
    f=nc_readS(fname,vname,tindex);
  end,
