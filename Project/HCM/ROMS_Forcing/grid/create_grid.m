function  create_grid(L,M,grdname)
...
nw{'e'} = ncdouble('eta_rho', 'xi_rho');
nw{'e'}.long_name = ncchar('NT Coriolis parameter at RHO-points');
nw{'e'}.long_name = 'NT Coriolis parameter at RHO-points';
nw{'e'}.units = ncchar('second-1');
nw{'e'}.units = 'second-1';
...
nw{'wtype_grid'} = ncdouble('eta_rho', 'xi_rho');
nw{'wtype_grid'}.long_name = ncchar('Water Type at RHO-points');
nw{'wtype_grid'}.long_name = 'Water Type at RHO-points';
nw{'wtype_grid'}.units = ncchar('1');
nw{'wtype_grid'}.units = '1';
