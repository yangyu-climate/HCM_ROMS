...
%                 V.ncType
%
% svn $Id: roms_metadata.m 754 2015-01-07 23:23:40Z arango $
%=========================================================================%
...
%--------------------------------------------------------------------------
 ...
 case 'spherical'
  ...
  case 'diff_factor'
    ...
    V.Size                    = [];
    V.Attributes(1).Name      = 'long_name';
    V.Attributes(1).Value     = 'Water Type at RHO-points';
    V.Attributes(2).Name      = 'Open Ocean';
    V.Attributes(2).Value     = double(1);
    V.Attributes(3).Name      = 'coordinates';
    if (spherical),
      V.Attributes(3).Value   = 'lon_rho lat_rho';
    else
